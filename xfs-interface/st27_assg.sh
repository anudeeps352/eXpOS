load --os $HOME/myexpos/spl/spl_progs/stage27_ostartup.xsm
load --library $HOME/myexpos/expl/library.lib
load --idle $HOME/myexpos/expl/samples/idle.xsm
load --init $HOME/myexpos/expl/samples/login.xsm
load --shell $HOME/myexpos/expl/samples/newshell.xsm
...
load --int=9 $HOME/myexpos/spl/spl_progs/int9st19.xsm
load --int=10 $HOME/myexpos/spl/spl_progs/int10.xsm
load --int=11 $HOME/myexpos/spl/spl_progs/int11.xsm
load --int=12 $HOME/myexpos/spl/spl_progs/int12check.xsm
...
load --int=16 $HOME/myexpos/spl/spl_progs/int16.xsm
load --int=17 $HOME/myexpos/spl/spl_progs/int17.xsm
load --int=console $HOME/myexpos/spl/spl_progs/consoleint.xsm
load --int=timer $HOME/myexpos/spl/spl_progs/timer.xsm
...
load --module 7 $HOME/myexpos/spl/spl_progs/bootmodule_27.xsm
load --exec $HOME/myexpos/expl/samples/odd_14.xsm
load --exec $HOME/myexpos/expl/samples/create.xsm
load --exec $HOME/myexpos/expl/samples/delete.xsm
load --exec $HOME/myexpos/expl/samples/read.xsm
...
load --exec $HOME/myexpos/expl/samples/linked.xsm
load --exec $HOME/myexpos/expl/samples/mergesq.xsm
load --exec $HOME/myexpos/expl/samples/mergecn.xsm
load --exec $HOME/myexpos/expl/samples/lu.xsm
load --exec $HOME/myexpos/expl/samples/ru.xsm
load --exec $HOME/myexpos/expl/samples/lu.xsm
load --exec $HOME/myexpos/expl/samples/ru.xsm
load --exec $HOME/myexpos/expl/samples/st27_assg1.xsm
load --exec $HOME/myexpos/expl/samples/st27_assg2.xsm
load --exec $HOME/myexpos/expl/samples/st27_assg3.xsm
load --exec $HOME/myexpos/expl/samples/st27_assg4.xsm
